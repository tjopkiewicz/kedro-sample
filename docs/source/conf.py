...
# airflow_k8s_plugin_demo documentation build
...
from airflow_k8s_plugin_demo import __version__ as release

# -- Project information -----------------------------------------------------

project = "airflow_k8s_plugin_demo"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "airflow_k8s_plugin_demodoc"
...
latex_documents = [
    (
        master_doc,
        "airflow_k8s_plugin_demo.tex",
        "airflow_k8s_plugin_demo Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "airflow_k8s_plugin_demo",
        "Project airflow_k8s_plugin_demo codebase.",
        "Data-Science",
    )
]
